...
remove them from the `.d`, and re-run detection. `at_risk` (WAL-mode header, complete
index, nothing beside it) can be searched as it is. Open any `analysis.tdf` yourself
